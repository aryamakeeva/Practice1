...
## Date: 29.10.2024
Далее провели поиск мутаций с помощью VarScan(varianr scaning), но для запуска его работы необзодимо подготовить промежуточный файл **mpileup** который считает количество немовпадений с рефересной молекулой. Для создания такого файла воспользовались следующей командой 
...
1. Добавить в snpEff.config файл, который лежит в директории вместе с файлом snpEff.jar добавить строчку **k12.genome : ecoli_K12**
